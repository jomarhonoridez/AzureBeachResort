// ==========================================================================
// Azure Beach Resort — Ocean Spa
// ==========================================================================

(function () {
  'use strict';

  const amenityId = 'ocean-spa';

  const amenity = {
    eyebrow: 'Ocean Spa',
    title: 'Ocean Spa',
    description:
      'Perched above the shoreline, our award-winning spa blends island botanicals with ocean-inspired rituals. From deep-tissue massages to signature seaweed wraps, every treatment restores body and mind.',
    features: [
      'Signature massage & body rituals',
      'Ocean-view treatment suites',
      'Steam room & saltwater sauna',

// ==========================================================================
// Azure Beach Resort — Water Sports
// ==========================================================================

(function () {
  'use strict';

  const amenityId = 'water-sports';

  const amenity = {
    eyebrow: 'Water Sports',
    title: 'Water Sports',
    description:
      'A full water-sports marina awaits: snorkel over coral gardens, paddle calm lagoons, or sail into the sunset. Certified instructors and top-of-the-line gear make every adventure safe and effortless.',
    features: [
      'Snorkeling & scuba diving',
      'Kayaking & stand-up paddleboarding',
      'Catamaran sunset sails',
      'Lessons & gear included',
    ],

// ==========================================================================
// Azure Beach Resort — Infinity Pool
// ==========================================================================

(function () {
  'use strict';

  const amenityId = 'infinity-pool';

  const amenity = {
    eyebrow: 'Infinity Pool',
    title: 'The Infinity Pool',
    description:
      'Our oceanfront infinity pool appears to melt into the horizon. Float in warm turquoise water while swim-up bartenders serve frozen cocktails, or settle into a shaded daybed with uninterrupted sunset views.',
    features: [
      'Swim-up bar with signature cocktails',
      'Heated saltwater all year round',
      'Reserved daybeds & private cabanas',
      'Towels and refreshments included',
    ],
    hours: 'Daily · 7:00 AM – 10:00 PM',
    images: [
      'https://images.unsplash.com/photo-1540541338287-41700207dee6?auto=format&fit=crop&w=900&q=80',
      'https://images.unsplash.com/photo-1520454974749-611b7248ffdb?auto=format&fit=crop&w=900&q=80',
